...
This is a reduced library, extracted from [cosmos72/gls](https://github.com/truthtracer/gls).
...
See the autogenerated API docs at http://godoc.org/github.com/truthtracer/gls
